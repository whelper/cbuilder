	...
	<div id="container">
		<div class="wrap-main">
			<ul class="card">
				...
				<li>
					<a href="/front/board/list/id/36">
					<h2 class="sample">진료사례</h2>
			...
			<div class="card-time">
				...
				<p class="ml25">- 일요일.공유일 휴진입니다</p>
			</div>
			<div class="card-tel">
				<div class="txt-tel">
					<h2>궁금한 사항은 언제든지 연락주세요</h2>
					<p class="mt10"><a href="tel:02-474-5450">TEL:<strong>02.474.5450</strong></a></p>
				</div>
			</div>
		</div>
	</div>
