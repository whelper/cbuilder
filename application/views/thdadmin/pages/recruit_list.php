	...
	<div class="col-lg-12">
		<div class="wrap-tab-lang">
			...
			<input type="hidden" name="language" value="<?=$this->language?>">	
				<select  name="keyname" class="form-control" style="width:150px;display:inline">
					<option value="">----------</option>
					<option value="title" <?=($this->input->get('keyname') == 'title') ? 'selected' : null?>>모집부문</option>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				 ...
				 <table class="table table-striped table-bordered table-hover">
					...
					<tbody class="tb-body">
						...
						<tr>
							...
							<td><?=$_list_no?></td>
							<td class="title"><a href="/thdadmin/recruit_form?language=<?=$_language?>&seq=<?=$row->seq?>&page=<?=$_page?>"><?=$row->title?></a></td>
				...
				<div class="row">
					<div class="col-md-6">
						<a class="btn btn-primary" href="/thdadmin/recruit_form?language=<?=$this->language?>" style="margin:20px 0;">등록</a>
					</div>
